#ifndef MYPUDHBUTTON_H
#define MYPUDHBUTTON_H

#include <QPushButton>
#include<QMouseEvent>

//这个是一个自己定义的一个按钮类，继承qpushbutton
//可以实现大部分的按钮功能，同时又有自己的属性
class mypudhbutton : public QPushButton
{
    Q_OBJECT
...
public:
    ...
    mypudhbutton(QString normalImage, QString pressImg="" );
